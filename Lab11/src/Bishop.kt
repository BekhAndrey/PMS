class Bishop(_colour: Colour) : ChessFigure {
    private val CANDIDATE_MOVE_VECTOR_COORDINATE: Array<Int> = arrayOf(-9,-7,7,9)
    override var name = "Bishop"
    var colour = _colour
    ...
    override fun figureTurn() {
        println("Available spots for bishop:")
